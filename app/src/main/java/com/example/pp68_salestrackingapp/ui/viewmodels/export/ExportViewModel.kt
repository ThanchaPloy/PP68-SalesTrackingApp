...
class ExportViewModel @Inject constructor(
    ...
    fun generateActivityCsvString(): String {
        ...
        builder.append("\uFEFF\u0e27\u0e31\u0e19\u0e17\u0e35\u0e48 (Date),\u0e1b\u0e23\u0e30\u0e40\u0e20\u0e17 (Type),\u0e2b\u0e31\u0e27\u0e02\u0e49\u0e2d (Topic),\u0e1a\u0e23\u0e34\u0e29\u0e31\u0e17 (Company),\u0e1c\u0e39\u0e49\u0e15\u0e34\u0e14\u0e15\u0e48\u0e2d (Contact),\u0e42\u0e04\u0e23\u0e07\u0e01\u0e32\u0e23 (Project),\u0e40\u0e0a\u0e47\u0e04\u0e2d\u0e34\u0e19 (Check-in),\u0e2a\u0e16\u0e32\u0e19\u0e30\u0e40\u0e0a\u0e47\u0e04\u0e2d\u0e34น (Check-in Status),\u0e2a\u0e16\u0e32\u0e19\u0e17\u0e35\u0e48\u0e19\u0e31\u0e14\u0e2b\u0e21\u0e32\u0e22 (Location Name),\u0e2a\u0e16\u0e32น\u0e30 (Status),\u0e2a\u0e16\u0e32\u0e19\u0e30\u0e43\u0e2b\u0e21\u0e48 (New Status),\u0e2a\u0e23\u0e38\u0e1b\u0e1c\u0e25 (Summary),\u0e23\u0e39\u0e1b\u0e20\u0e32\u0e1e (Photos),\u0e42\u0e2d\u0e01\u0e32\u0e2a (Opportunity),\u0e43\u0e1a\u0e40\u0e2a\u0e19\u0e2d\u0e23\u0e32\u0e04\u0e32 (Proposal),\u0e27\u0e31\u0e19\u0e17\u0e35\u0e48\u0e40\u0e2a\u0e19\u0e2d\u0e23\u0e32\u0e04\u0e32 (Proposal Date),DM \u0e23\u0e48\u0e27\u0e21\u0e1b\u0e23\u0e30\u0e0a\u0e38\u0e21 (DM Involved),\u0e08\u0e33\u0e19\u0e27\u0e19\u0e04\u0e39\u0e48\u0e41\u0e02\u0e48\u0e07 (CompetitorCount),\u0e04\u0e27\u0e32\u0e21\u0e40\u0e23\u0e47\u0e27 (Speed),\u0e2a\u0e16\u0e32\u0e19\u0e30\u0e14\u0e35\u0e25 (Deal),\u0e42\u0e0b\u0e25\u0e39\u0e0a\u0e31\u0e48\u0e19\u0e40\u0e14\u0e34\u0e21 (Solution),\u0e40\u0e2b\u0e15\u0e38\u0e1c\u0e25\u0e41\u0e1e\u0e49 (Loss)\n")
